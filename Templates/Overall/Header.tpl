...
<head>
    ...
    <link rel="stylesheet" href="assets/css/bootstrap.min.css?v={0|rand:100}" media="screen">

    <link rel="stylesheet" href="assets/metisMenu/metisMenu.min.css" media="screen">

    <link rel="stylesheet" href="assets/css-admin/sb-admin-2.min.css" media="screen">

    <link rel="stylesheet" href="assets/css/login.css?v={0|rand:100}" media="screen">
